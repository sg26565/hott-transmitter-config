...
public class MdlViewerActivity extends Activity implements UncaughtExceptionHandler {
  ...
  public void onCreate(final Bundle savedInstanceState) {
    ...
    if (NAVIGATION_SUPPORTED) {
      ...
      bookmarks = getResources().getStringArray(R.array.bookmarks);
      drawerLayout = (DrawerLayout) findViewById(R.id.drawer_layout);
      drawer = (ListView) findViewById(R.id.drawer);
      drawer.setAdapter(new ArrayAdapter<String>(this, R.layout.drawer_list_item, bookmarks));
    } else {
      webView = new WebView(this);
      webView.setId(R.id.webwiew);
