...
public class CdcAcmSerialDriver implements UsbSerialDriver {
    ...
    class CdcAcmSerialPort extends CommonUsbSerialPort {
        ...
        private static final int SET_LINE_CODING        = 0x20;                                             // USB
                                                                                                             // CDC
                                                                                                             // 1.1
                                                                                                             // section
                                                                                                             // 6.2
        ...
        public int read(final byte[] dest, final int timeoutMillis) throws IOException {
            if (mEnableAsyncReads) {
                ...
                try {
                    ...
                    if (nread > 0) {
                        // Log.d(TAG, HexDump.dumpHexString(dest, 0,
        ...
        public void setParameters(final int baudRate, final int dataBits, final int stopBits, final int parity) {
            ...
            final byte[] msg = { (byte) (baudRate & 0xff), (byte) (baudRate >> 8 & 0xff), (byte) (baudRate >> 16 & 0xff), (byte) (baudRate >> 24 & 0xff),
                    stopBitsByte, parityBitesByte, (byte) dataBits };
        ...
        private void setDtrRts() {
            final int value = (mRts ? 0x2 : 0) | (mDtr ? 0x1 : 0);
    ...
    public static Map<Integer, int[]> getSupportedDevices() {
        ...
        supportedDevices.put(Integer.valueOf(UsbId.VENDOR_ARDUINO), new int[] { UsbId.ARDUINO_UNO, UsbId.ARDUINO_UNO_R3, UsbId.ARDUINO_MEGA_2560,
                UsbId.ARDUINO_MEGA_2560_R3, UsbId.ARDUINO_SERIAL_ADAPTER, UsbId.ARDUINO_SERIAL_ADAPTER_R3, UsbId.ARDUINO_MEGA_ADK, UsbId.ARDUINO_MEGA_ADK_R3,
