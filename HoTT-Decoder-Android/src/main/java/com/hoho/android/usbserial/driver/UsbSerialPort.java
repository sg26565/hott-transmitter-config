...
public interface UsbSerialPort {
     ...
     * 
     * @param flushRX
     *            {@code true} to flush non-transmitted output data
     * @param flushTX
     *            {@code true} to flush non-read input data
     * @return {@code true} if the operation was successful, or {@code false} if
     *         the operation is not supported by the driver or device
     * @throws IOException
