...
public class WingedPhase extends Phase {
    ...
    public boolean equals(final Object obj) {
        ...
        if (brakeElevatorCurve == null) {
            if (other.brakeElevatorCurve != null) return false;
        } else if (!brakeElevatorCurve.equals(other.brakeElevatorCurve)) return false;
        if (!Arrays.equals(brakeMixer, other.brakeMixer)) return false;
        if (!Arrays.equals(multiFlapMixer, other.multiFlapMixer)) return false;
        if (!Arrays.equals(wingMixer, other.wingMixer)) return false;
        if (wingTrim == null) {
            if (other.wingTrim != null) return false;
        } else if (!wingTrim.equals(other.wingTrim)) return false;
        return true;
    }
