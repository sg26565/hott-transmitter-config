...
public class WingedTrim extends AbstractBase {
    ...
    public boolean equals(final Object obj) {
        ...
        if (!Arrays.equals(aileronPhaseTrim, other.aileronPhaseTrim)) return false;
        if (aileronStickTrim != other.aileronStickTrim) return false;
        if (elevatorPhaseTrim != other.elevatorPhaseTrim) return false;
        if (elevatorStickTrim != other.elevatorStickTrim) return false;
        if (!Arrays.equals(flapPhaseTrim, other.flapPhaseTrim)) return false;
        if (rudderStickTrim != other.rudderStickTrim) return false;
        return true;
    }
