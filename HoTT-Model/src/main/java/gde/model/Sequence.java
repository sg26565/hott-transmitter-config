...
public class Sequence extends AbstractBase {
    ...
    public boolean equals(final Object obj) {
        ...
        if (outputChannel == null) {
            if (other.outputChannel != null) return false;
        } else if (!outputChannel.equals(other.outputChannel)) return false;
        if (!Arrays.equals(stepPosition, other.stepPosition)) return false;
        return true;
    }
