...
public class DualRateExpo extends AbstractBase {
    ...
    public boolean equals(final Object obj) {
        ...
        if (dualRate == null) {
            if (other.dualRate != null) return false;
        } else if (!dualRate.equals(other.dualRate)) return false;
        if (expo == null) {
            if (other.expo != null) return false;
        } else if (!expo.equals(other.expo)) return false;
        return true;
    }
