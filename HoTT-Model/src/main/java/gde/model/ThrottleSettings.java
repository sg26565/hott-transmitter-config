...
public class ThrottleSettings extends AbstractBase {
    ...
    public boolean equals(final Object obj) {
        ...
        if (throttleCutOf == null) {
            if (other.throttleCutOf != null) return false;
        } else if (!throttleCutOf.equals(other.throttleCutOf)) return false;
        if (throttleLastIdlePosition != other.throttleLastIdlePosition) return false;
        if (throttleTrim != other.throttleTrim) return false;
        return true;
    }
