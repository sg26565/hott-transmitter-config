...
public class HelicopterMixer extends AbstractBase {
    ...
    public boolean equals(final Object obj) {
        ...
        if (nick2TailMix != other.nick2TailMix) return false;
        if (nick2ThrottleMix != other.nick2ThrottleMix) return false;
        if (pitchCurve == null) {
            if (other.pitchCurve != null) return false;
        } else if (!pitchCurve.equals(other.pitchCurve)) return false;
        if (roll2TailMix != other.roll2TailMix) return false;
        if (roll2ThrottleMix != other.roll2ThrottleMix) return false;
        if (swashplateLimit != other.swashplateLimit) return false;
        if (swashplateRotation != other.swashplateRotation) return false;
        if (tail2ThrottleMix != other.tail2ThrottleMix) return false;
        if (tailCurve == null) {
            if (other.tailCurve != null) return false;
        } else if (!tailCurve.equals(other.tailCurve)) return false;
        if (throttleCurve == null) {
            if (other.throttleCurve != null) return false;
        } else if (!throttleCurve.equals(other.throttleCurve)) return false;
        return true;
    }
