...
public class HelicopterPhase extends Phase {
    ...
    public boolean equals(final Object obj) {
        ...
        if (helicopterMixer == null) {
            if (other.helicopterMixer != null) return false;
        } else if (!helicopterMixer.equals(other.helicopterMixer)) return false;
        if (helicopterTrim == null) {
            if (other.helicopterTrim != null) return false;
        } else if (!helicopterTrim.equals(other.helicopterTrim)) return false;
        return true;
    }
