...
import de.treichels.hott.model.enums.MultichannelMode;
...
public class Multichannel extends AbstractBase {
    ...
    public boolean equals(final Object obj) {
        ...
        if (inputChannel == null) {
            if (other.inputChannel != null) return false;
        } else if (!inputChannel.equals(other.inputChannel)) return false;
