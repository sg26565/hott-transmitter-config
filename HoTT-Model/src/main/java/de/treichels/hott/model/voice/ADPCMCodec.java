...
public class ADPCMCodec {
     ...
     * @throws IOException
     */
    public static InputStream decode(final InputStream source) {
     ...
     * @throws IOException
     */
    public static InputStream encode(final InputStream source) {
        return encode(source, 1.0);
    }

    public static InputStream encode(final InputStream source, double volume) {
