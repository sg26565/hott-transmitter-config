...
public class MdlTabItemComposite extends Composite {
    ...
    private void loadFromFile() {
        ...
        fd.setFilterPath(PREFS.get(LAST_LOAD_DIR, System.getProperty(gde.mdl.ui.Launcher.MDL_DIR)));
    ...
    private void save() {
        if (model != null) {
            ...
            fd.setFilterPath(PREFS.get(LAST_SAVE_DIR, PREFS.get(LAST_LOAD_DIR, System.getProperty(gde.mdl.ui.Launcher.MDL_DIR))));
