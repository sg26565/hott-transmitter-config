...
class Win10TTSProvider : Text2SpeechProvider() {
    ...
    override fun installedVoices(): List<Voice> {
        ...
        val process = Runtime.getRuntime().exec("PowerShell.exe -EncodedCommand $installedVoices")
...
"""
            ...
            // start PowerShell runtime
            process = Runtime.getRuntime().exec("PowerShell.exe -EncodedCommand $encoded")
