...
final class RS485 extends RS485Port {
    ...
    class MonitorThread extends Thread {
        /**
         * Note: these have to be separate boolean flags because the RS485PortEvent constants are NOT bit-flags, they are just defined as integers from 1 to 10
         * -DPL
         */
    ...
    class RS485InputStream extends InputStream {
        ...
        public int read(final byte b[], final int off, final int len) throws IOException {
            ...
            /*
             * find the lowest nonzero value timeout and threshold are handled on the native side see NativeEnableReceiveTimeoutThreshold in RS485Imp.c
             */
    ...
    /** Open the named port */
    public RS485(final String name) throws PortInUseException {
        fd = open(name);
    }

    /** Add an event listener */
    @Override
    public void addEventListener(final RS485PortEventListener lsnr) throws TooManyListenersException {
    ...
    public void sendEvent(final int event, final boolean state) {
        ...
        case RS485PortEvent.OUTPUT_BUFFER_EMPTY:
            ...
            return;
        /*
         * if( monThread.DSR ) break; return; if (isDSR()) { if (!dsrFlag) { dsrFlag = true; RS485PortEvent e = new RS485PortEvent(this, RS485PortEvent.DSR,
         * !dsrFlag, dsrFlag ); } } else if (dsrFlag) { dsrFlag = false; RS485PortEvent e = new RS485PortEvent(this, RS485PortEvent.DSR, !dsrFlag, dsrFlag ); }
         */
        ...
        final RS485PortEvent e = new RS485PortEvent(this, event, !state, state);
    ...
    @Override
    public void setRS485PortParams(final int b, final int d, final int s, final int p) throws UnsupportedCommOperationException {
