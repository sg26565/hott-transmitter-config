...
public class Library {
    ...
    static boolean extract(final String fileName, final String mappedName) {
    ...
    /**
     * Loads the shared library that matches the version of the Java code which is currently running. SWT shared libraries follow an encoding scheme where the
     * major, minor and revision numbers are embedded in the library name and this along with <code>name</code> is used to load the library. If this fails,
     * <code>name</code> is used in another attempt to load the library, this time ignoring the SWT version encoding scheme.
     *
     * @param name
    ...
    public static void loadLibrary(final String name, final boolean mapName) {
        ...
        // System.out.println("...loading library from library path : libname =
        // " + libName);
        ...
        // System.out.println("...loading library from java.io.tmpdir : libname
        // = " + path + SEPARATOR + mappedName);
        ...
        if (path != null) // System.out.println("...extracting library to java.io.tmpdir : " +
            // osPath + mappedName);
