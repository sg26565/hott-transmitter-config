...
final class Raw extends RawPort {
    ...
    class MonitorThread extends Thread {
        /**
         * Note: these have to be separate boolean flags because the RawPortEvent constants are NOT bit-flags, they are just defined as integers from 1 to 10
         * -DPL
         */
    ...
    public void sendEvent(final int event, final boolean state) {
        ...
        case RawPortEvent.OUTPUT_BUFFER_EMPTY:
            ...
            return;
        /*
         * if( monThread.DSR ) break; return; if (isDSR()) { if (!dsrFlag) { dsrFlag = true; RawPortEvent e = new RawPortEvent(this, RawPortEvent.DSR, !dsrFlag,
         * dsrFlag ); } } else if (dsrFlag) { dsrFlag = false; RawPortEvent e = new RawPortEvent(this, RawPortEvent.DSR, !dsrFlag, dsrFlag ); }
         */
